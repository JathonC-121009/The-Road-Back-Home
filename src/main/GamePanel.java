...
public class GamePanel extends JPanel implements Runnable{
    ...
    public void setUpGame() {
        ...
        //sound.setFile(1, "res/sound/mixkit-casino-bling-achievement-2067.wav");
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        } else if (gameState == introductionState) {
            int x = 10;
            int y = 40;
    ...
    public void showCredits() {
        gameState = creditsState; // Set game state to credits
    ...
    public void startIntroductionTimer() {
        new Thread(() -> {
            try {
                ...
                gameState = playState; // Transition to play state
